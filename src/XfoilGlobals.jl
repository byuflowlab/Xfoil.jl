...
function getglobals()
  ...
  cc02 = getCC02()
  cc03 = getCC03()
  xfoilglobals = globalstruct(cr01,cr03...,cr04...,cr05...,cr06...,cr07...,
...
function getCR01()
  cr01 = cglobal((:cr01_,"libjlxlight"),Float64)
...
function getCR03(IQX=286,IZX=322)
  cr03 = cglobal((:cr03_,"libjlxlight"),Float64)
...
function getCR04(IZX=322)
  cr04 = cglobal((:cr04_,"libjlxlight"),Float64)
...
function getCR05(IZX=322,IWK=36)
  cr05 = cglobal((:cr05_,"libjlxlight"),Float64)
...
function getCR06(IQX=286,IZX=322)
  cr06 = cglobal((:cr06_,"libjlxlight"),Float64)
...
function getCR07(IBX=572,IPX=5,IQX=286)
  cr07 = cglobal((:cr07_,"libjlxlight"),Float64)
...
function getCR09()
  cr09 = cglobal((:cr09_,"libjlxlight"),Float64)
...
function getCR10(IQX=286,NPX=8,ISX=2)
  cr10 = cglobal((:cr10_,"libjlxlight"),Float64)
...
function getCR11()
  cr11= cglobal((:cr11_,"libjlxlight"),Float64)
...
function getCR12()
  cr12= cglobal((:cr12_,"libjlxlight"),Float64)
...
function getCR13()
  cr13 = cglobal((:cr12_,"libjlxlight"),Float64)
...
function getCR14(IBX=572)
  cr14 = cglobal((:cr14_,"libjlxlight"),Float64)
...
function getCR15(IVX=229,ISX=2)
  cr15 = cglobal((:cr15_,"libjlxlight"),Float64)
...
function getCR17()
  cr17 = cglobal((:cr17_,"libjlxlight"),Float64)
...
function getCR18()
  cr18 = cglobal((:cr18_,"libjlxlight"),Float64)
...
function getQMAT(IQX=286,IZX=322)
  qmat = cglobal((:qmat_,"libjlxlight"),Float64)
...
function getVMAT(IZX = 322)
  vmat = cglobal((:vmat_,"libjlxlight"),Float64)
...
function getCI01()
  ci01 = cglobal((:ci01_,"libjlxlight"),Int32)
...
function getCI03(NPX=8)
  ci03 = cglobal((:ci03_,"libjlxlight"),Int32)
...
function getCI04(ISX=2)
  ci04 = cglobal((:ci04_,"libjlxlight"),Int32)
...
function getCI05(ISX=2,IVX=229)
  ci05 = cglobal((:ci05_,"libjlxlight"),Int32)
...
function getCI06()
  ci06 = cglobal((:ci06_,"libjlxlight"),Int32)
...
function getCL01()
  cl01 = cglobal((:cl01_,"libjlxlight"),Int32)
...
function getCL02(ISX=2)
  cl02 = cglobal((:cl02_,"libjlxlight"),Int32)
...
function getCC01()
  cc01 = cglobal((:cc01_,"libjlxlight"),UInt8)
...
function getCC02()
  cc02 = cglobal((:cc02_,"libjlxlight"),UInt8)
...
function getCC03()
  cc03 = cglobal((:cc03_,"libjlxlight"),UInt8)
