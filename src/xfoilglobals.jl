...
function getglobals()
  ...
  cr01 = cglobal((:cr01_,libxfoil_light),Float64)
  version = unsafe_wrap(Array,cr01,1)

  cr03 = cglobal((:cr03_,libxfoil_light),Float64)
  aij = unsafe_wrap(Array,cr03,(IQX,IQX))
  dij = unsafe_wrap(Array,cr03+sizeof(Float64)*IQX^2,(IZX,IZX))

  cr04 = cglobal((:cr04_,libxfoil_light),Float64)
  ...
  cr05 = cglobal((:cr05_,libxfoil_light),Float64)
  ...
  cr06 = cglobal((:cr06_,libxfoil_light),Float64)
  ...
  cr07 = cglobal((:cr07_,libxfoil_light),Float64)
  ...
  cr09 = cglobal((:cr09_,libxfoil_light),Float64)
  ...
  cr10 = cglobal((:cr10_,libxfoil_light),Float64)
  ...
  cr11= cglobal((:cr11_,libxfoil_light),Float64)
  ...
  cr12= cglobal((:cr12_,libxfoil_light),Float64)
  ...
  cr13 = cglobal((:cr12_,libxfoil_light),Float64)
  ...
  cr14 = cglobal((:cr14_,libxfoil_light),Float64)
  ...
  cr15 = cglobal((:cr15_,libxfoil_light),Float64)
  ...
  cr17 = cglobal((:cr17_,libxfoil_light),Float64)
  ...
  cr18 = cglobal((:cr18_,libxfoil_light),Float64)
  ...
  qmat = cglobal((:qmat_,libxfoil_light),Float64)
  ...
  vmat = cglobal((:vmat_,libxfoil_light),Float64)
  ...
  ci01 = cglobal((:ci01_,libxfoil_light),Int32)
  ...
  ci03 = cglobal((:ci03_,libxfoil_light),Int32)
  ...
  ci04 = cglobal((:ci04_,libxfoil_light),Int32)
  ...
  ci05 = cglobal((:ci05_,libxfoil_light),Int32)
  ...
  ci06 = cglobal((:ci06_,libxfoil_light),Int32)
  imxbl = unsafe_wrap(Array,ci06,1)
  ismxbl = unsafe_wrap(Array,ci06+sizeof(Int32),1)

  cl01 = cglobal((:cl01_,libxfoil_light),Int32)
  ...
  cl02 = cglobal((:cl02_,libxfoil_light),Int32)
  tforce = unsafe_wrap(Array,cl02,ISX)

  cc01 = cglobal((:cc01_,libxfoil_light),UInt8)
  ...
  cc02 = cglobal((:cc02_,libxfoil_light),UInt8)
  labref = unsafe_string(cc02,32)

  cc03 = cglobal((:cc03_,libxfoil_light),UInt8)
