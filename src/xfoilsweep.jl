...
- `y`:
- `aoa`: Array of angle of attacks in radians
...
"""
function xfoilsweep(x,y,aoa,re::Real;mach::Real=0.0,iter::Integer=50,
...
function xfoilsweep(x,y,aoa,re::Real,mach::Real,iter::Integer,
