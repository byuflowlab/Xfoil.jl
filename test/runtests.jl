...
# set_coordinates_cs test
Xfoil.set_coordinates_cs(x .+ 1e-20im, y .+ 1e-20im)
...
# solve_alpha_cs test
cl_cs, cd_cs, cdp_cs, cm_cs, conv_cs = solve_alpha_cs(5.0+1e-20im, 1e5,
    iter=100)
...
cls_cs, cds_cs, cdps_cs, cms_cs, convs_cs = alpha_sweep_cs(x, y, aoas_cs, 1e5;
